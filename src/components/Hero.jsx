...
const Hero = () => {
  const heroImages = [
    'https://res.cloudinary.com/dn9yo8x89/image/upload/v1753193296/2_wgqwv2.png',
    'https://res.cloudinary.com/dn9yo8x89/image/upload/v1753193301/1_bifbbg.png',
  ...
  return (
    ...
    >
      {isMediumUp && <SwiperSlide >
        <div
          className=" hidden md:block w-full h-screen bg-cover bg-center relative "
          style={{ backgroundImage: `url('https://res.cloudinary.com/dn9yo8x89/image/upload/v1753193323/IMG_20250722_140941324_tbj89i.jpg')` }}
        >
          {/* Overlay */}
